...
public class ConsumerService {
    ...
    @KafkaListener(topics = "order-event-process", groupId = "pay-event-process-id")
    public void consume(ShoppingEventDto dto) {
        System.out.println("페이 서비스 수신된 메시지: " + dto);
    }


    @KafkaListener(topics = "payment-event-topic", groupId = "pay-event-process-id")
